...
class HardpLevelScreen extends StatefulWidget {
  const HardpLevelScreen({super.key});

  @override
  _HardpLevelScreenState createState() => _HardpLevelScreenState();
}

class _HardpLevelScreenState extends State<HardpLevelScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Hard Level Questions'),
      ),
      body: Padding(
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("Python", "Hard", "Theory", scoreTheory);
                });
              },
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("Python", "Hard", "Coding", scoreCoding);
                });
              },
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("Python", "Hard", "Aptitude", scoreAptitude);
                });
              },
