...
class MediumpLevelScreen extends StatefulWidget {
  const MediumpLevelScreen({super.key});

  @override
  _MediumpLevelScreenState createState() => _MediumpLevelScreenState();
}

class _MediumpLevelScreenState extends State<MediumpLevelScreen> {
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("Python", "Medium", "Theory", scoreTheory);
                });
              },
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("Python", "Medium", "Coding", scoreCoding);
                });
              },
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("Python", "Medium", "Aptitude", scoreAptitude);
                });
              },
