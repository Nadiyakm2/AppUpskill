...
class EasypLevelScreen extends StatefulWidget {
  const EasypLevelScreen({super.key});

  @override
  _EasypLevelScreenState createState() => _EasypLevelScreenState();
}

class _EasypLevelScreenState extends State<EasypLevelScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Easy Level Questions'),
      ),
      body: Padding(
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("Python", "Easy", "Theory", scoreTheory);
                });
              },
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("Python", "Easy", "Coding", scoreCoding);
                });
              },
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("Python", "Easy", "Aptitude", scoreAptitude);
                });
              },
...
class _ExpandableContainerState extends State<ExpandableContainer> {
  ...
  Widget _buildOption(String option, int questionIndex, int optionIndex) {
    return ListTile(
      ...
      leading: Radio<int>(
        value: optionIndex,
        // The value of the option (0, 1, 2, or 3)
        groupValue: widget.selectedAnswers[questionIndex],
