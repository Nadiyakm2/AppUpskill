...
class EasycLevelScreen extends StatefulWidget {
  const EasycLevelScreen({super.key});

  @override
  _EasycLevelScreenState createState() => _EasycLevelScreenState();
}

class _EasycLevelScreenState extends State<EasycLevelScreen> {
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("C", "Easy", "Theory", scoreTheory);
                });
              },
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("C", "Easy", "Coding", scoreCoding);
                });
              },
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("C", "Easy", "Aptitude", scoreAptitude);
                });
              },
