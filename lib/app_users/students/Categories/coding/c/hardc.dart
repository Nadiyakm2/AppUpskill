...
class HardcLevelScreen extends StatefulWidget {
  const HardcLevelScreen({super.key});

  @override
  _HardcLevelScreenState createState() => _HardcLevelScreenState();
}

class _HardcLevelScreenState extends State<HardcLevelScreen> {
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("C", "Hard", "Theory", scoreTheory);
                });
              },
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("C", "Hard", "Coding", scoreCoding);
                });
              },
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("C", "Hard", "Aptitude", scoreAptitude);
                });
              },
