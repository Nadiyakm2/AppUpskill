...
class MediumcLevelScreen extends StatefulWidget {
  const MediumcLevelScreen({super.key});

  @override
  _MediumcLevelScreenState createState() => _MediumcLevelScreenState();
}

class _MediumcLevelScreenState extends State<MediumcLevelScreen> {
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("C", "Medium", "Theory", scoreTheory);
                });
              },
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("C", "Medium", "Coding", scoreCoding);
                });
              },
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("C", "Medium", "Aptitude", scoreAptitude);
                });
              },
