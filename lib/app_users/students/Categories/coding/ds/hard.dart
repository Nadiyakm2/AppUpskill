...
class HardLevelScreen extends StatefulWidget {
  const HardLevelScreen({super.key});

  @override
  _HardLevelScreenState createState() => _HardLevelScreenState();
}
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("Data Structures", "Hard", "Theory", scoreTheory);
                });
              },
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("Data Structures", "Hard", "Coding", scoreCoding);
                });
              },
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("Data Structures", "Hard", "Aptitude", scoreAptitude);
                });
              },
