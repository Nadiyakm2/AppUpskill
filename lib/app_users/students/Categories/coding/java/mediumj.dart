...
class MediumjLevelScreen extends StatefulWidget {
  const MediumjLevelScreen({super.key});

  @override
  _MediumjLevelScreenState createState() => _MediumjLevelScreenState();
}

class _MediumjLevelScreenState extends State<MediumjLevelScreen> {
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("Java", "Medium", "Theory", scoreTheory);
                });
              },
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("Java", "Medium", "Coding", scoreCoding);
                });
              },
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("Java", "Medium", "Aptitude", scoreAptitude);
                });
              },
