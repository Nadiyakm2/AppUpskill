...
class HardjLevelScreen extends StatefulWidget {
  const HardjLevelScreen({super.key});

  @override
  _HardjLevelScreenState createState() => _HardjLevelScreenState();
}

class _HardjLevelScreenState extends State<HardjLevelScreen> {
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("Java", "Hard", "Theory", scoreTheory);
                });
              },
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("Java", "Hard", "Coding", scoreCoding);
                });
              },
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("Java", "Hard", "Aptitude", scoreAptitude);
                });
              },
