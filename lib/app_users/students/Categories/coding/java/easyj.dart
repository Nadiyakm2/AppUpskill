...
class EasyjLevelScreen extends StatefulWidget {
  const EasyjLevelScreen({super.key});

  @override
  _EasyjLevelScreenState createState() => _EasyjLevelScreenState();
}

class _EasyjLevelScreenState extends State<EasyjLevelScreen> {
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("Java", "Easy", "Theory", scoreTheory);
                });
              },
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("Java", "Easy", "Coding", scoreCoding);
                });
              },
            ...
            ExpandableContainer(
              ...
              onSubmit: () {
                setState(() {
                  ...
                  _submitDataToSupabase("Java", "Easy", "Aptitude", scoreAptitude);
                });
              },
